...
const statistics = {
  ...
  "goods": 84,
  "conversion": 14,
  "totalСostOfGoods": 1295,
  "objectiveOrdersComplite": 352,
  "objectiveConversion": 18
}

const { objectiveOrdersComplite, ordersComplite } = statistics
const data = [
  {
    name: 'январь', uv: ordersComplite, pv: 2400, amt: 2400,
  },
  {
...
export default class ChartwithSmiles extends PureComponent {
  ...
  render() {
    return (
      <LineChart
        ...
        data={data}
        margin={{
          top: 50, right: 80, left: 10, bottom: 50,
        }}
      >
